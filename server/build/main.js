...
router.post('/signup', async ctx => {
  ...
  let findUser = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    username: credentials.username
  });
  let findEmail = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./src/utils/index.js");
/* harmony import */ var _products__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./products */ "./src/products/index.js");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth */ "./src/auth/index.js");
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user */ "./src/user/index.js");
...
app.use(_koa_cors__WEBPACK_IMPORTED_MODULE_8___default()());
...
app.use(koa_jwt__WEBPACK_IMPORTED_MODULE_7___default()(_utils__WEBPACK_IMPORTED_MODULE_3__["jwtConfig"])); // protected

const protectedApiRouter = new koa_router__WEBPACK_IMPORTED_MODULE_1___default.a({
  prefix
});
protectedApiRouter.use('/products', _products__WEBPACK_IMPORTED_MODULE_4__["router"].routes()).use('/users', _user__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/products/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "router", function() { return router; });
/* harmony import */ var _panderalabs_koa_pageable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @panderalabs/koa-pageable */ "@panderalabs/koa-pageable");
/* harmony import */ var _panderalabs_koa_pageable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_panderalabs_koa_pageable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store */ "./src/products/store.js");



const router = new koa_router__WEBPACK_IMPORTED_MODULE_1___default.a();
router.get('/', _panderalabs_koa_pageable__WEBPACK_IMPORTED_MODULE_0__["paginate"], async ctx => {
  ctx.body = result;
  const response = ctx.response;
  response.body = await _store__WEBPACK_IMPORTED_MODULE_2__["default"].find({});
...
router.get('/:id', async ctx => {
  const product = await _store__WEBPACK_IMPORTED_MODULE_2__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createProduct = async (product, response) => {
  try {
    response.body = await _store__WEBPACK_IMPORTED_MODULE_2__["default"].insert(product);
    response.status = 201; // created
  } catch (err) {
    response.body = {
      issue: [{
...
router.post('/', async ctx => await createProduct(ctx.request.body, ctx.response)); // router.put('/:id', async (ctx) => {
...
router.put('/:id', async ctx => {
  ...
  if (productId && productId !== id) {
    response.body = {
      issue: [{
        error: 'Param id and body _id should be the same'
      }]
    };
    response.status = 400; // bad request
...
/***/ "./src/products/store.js":
/*!*******************************!*\
  !*** ./src/products/store.js ***!
  \*******************************/
/*! exports provided: ProductStore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (new ProductStore({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/user/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _auth_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../auth/store */ "./src/auth/store.js");


const router = new koa_router__WEBPACK_IMPORTED_MODULE_0___default.a();
router.get('/', async ctx => {
  const response = ctx.response;
  response.body = await _auth_store__WEBPACK_IMPORTED_MODULE_1__["default"].find({});
  response.status = 200; // ok
});
router.get('/:id', async ctx => {
  const user = await _auth_store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createUser = async (user, response) => {
  try {
    response.body = await _auth_store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(user);
    response.status = 201; // created
  } catch (err) {
    response.body = {
      issue: [{
...
router.put('/:id', async ctx => {
  ...
  if (!userId) {
    ...
    const updatedCount = await _auth_store__WEBPACK_IMPORTED_MODULE_1__["default"].update({
      _id: id
    }, user);
...
router.del('/:id', async ctx => {
  await _auth_store__WEBPACK_IMPORTED_MODULE_1__["default"].remove({
    _id: ctx.params.id
  });
  ctx.response.status = 204; // no content
});
...
module.exports = __webpack_require__(/*! C:\Users\Denisa Urluescu\Desktop\angular-cli\todo-angular-app\server\src/index.js */"./src/index.js");
...
/*!********************************************!*\
  !*** external "@panderalabs/koa-pageable" ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("@panderalabs/koa-pageable");
